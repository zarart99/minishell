...
/*   Updated: 2024/12/01 15:39:53 by mmychaly         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char		*handle_tilde_argument(t_data *data, char *arg, char *old_pwd,
				int *free_target_dir);
int			change_and_update_env(t_data *data, char *target_dir,
				char *old_pwd);
...
int			exit_cmds_builtin(t_data *data, char *error, int status,
				char *most_by_free);
...
void		handle_missing_after(t_cmd *cmd, char *before, char *redir,
				char *after);
